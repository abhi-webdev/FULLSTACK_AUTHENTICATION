...
{/* Enter the email id */}
      ...
      <form onSubmit={onSubmitEmail} className="bg-slate-900 p-8 rounded-lg shadow-lg w-96 text-sm">
        ...
        <button className="w-full py-2.5 bg-gradient-to-r from-indigo-500 to to-indigo-900 text-white rounded-full mt-3" >Submit</button>
      </form>
    }
...
{/* otp input form  */}
      ...
      <form onSubmit={onSubmitOTP} className="bg-slate-900 p-8 rounded-lg shadow-lg w-96 text-sm">
        ...
        <button className="w-full py-2.5 bg-gradient-to-r  from-indigo-500 to-indigo-900 text-wrap rounded-full">Submit</button>
      </form>
   }   
